...
public:
    ...
    inline void  getAddress(Char_t& m, Char_t& l, Char_t& p, Int_t& s) const;
    ...
    inline void  setAddress(Char_t m, Char_t l, Char_t p, Int_t s);
...
void HFwDetStrawCal::getAddress(Char_t &m, Char_t &l, Char_t &p, Int_t &s) const
{
    m = fModule;
    l = fLayer;
    p = fPlane;
...
void HFwDetStrawCal::setAddress(Char_t m, Char_t l, Char_t p, Int_t s)
{
    fModule = m;
    fLayer  = l;
    fPlane  = p;
