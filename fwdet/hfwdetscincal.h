...
inline void HFwDetScinCal::getAddress(Char_t& m, Char_t& c, Char_t& s) const
{
    m = fModule;
    c = fGeantCell;
    s = fScin;
...
inline void HFwDetScinCal::setAddress(const Char_t m, const Char_t c, const Char_t s)
{
    fModule    = m;
    fGeantCell = c;
    fScin      = s;
...
inline void HFwDetScinCal::getHit(Float_t& time, Float_t& elos) const
{
    time = fTime;
    elos = fElos;
}

inline void HFwDetScinCal::setHit(const Float_t time, const Float_t elos)
{
    fTime = time;
    fElos = elos;
}
