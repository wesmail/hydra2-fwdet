...
day=095
submmissionbase=/hera/hades/user/${user}/sub/apr12/test
submissiondir=${submmissionbase}/loopDST
 nFilesPerJob=10                                # number of files to be analyzed by 1 job (default==1)
    ...
    outputdir=/hera/hades/user/${user}/apr12/loop # outputdir for files AND logFiles
...
par1=/cvmfs/hades.gsi.de/install/5.34.01/hydra2-3.8/defall.sh  # optional par1 : environment script
...
resources="-l h_rt=4:0:0,h_vmem=2G"                            # runtime < 10h, mem < 2GB
