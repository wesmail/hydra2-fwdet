...
submmissionbase=/lustre/nyx/hades/user/${user}/sub
submissiondir=${submmissionbase}/urqmd
 nFilesPerJob=1                                 # number of files to be analyzed by 1 job (default==1)
    ...
    outputdir=/lustre/nyx/hades/dstsim/apr12/urqmd/${urqmdout}/new/${part}  # outputdir for files AND logFiles
...
par1=/cvmfs/hades.gsi.de/install/urqmd-3.3p2/urqmd                       # urqmd exe
