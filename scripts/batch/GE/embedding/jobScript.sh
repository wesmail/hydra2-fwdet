...
then
  ...
  echo ./pluto_embedded  ${outdir}/pluto ${plutofile} ${nevents} ${outdir}/vertex/${vertexfile} ${particle}
./pluto_embedded  ${outdir}/pluto ${plutofile} ${nevents} ${outdir}/vertex/${vertexfile} ${particle}
   status=$?
fi
...
###################################################################
    ...
    mv ${pathoutputlog}/${JOB_NAME}.o${JOB_ID}.${SGE_TASK_ID} ${pathoutputlog}/${hldfile}.log
