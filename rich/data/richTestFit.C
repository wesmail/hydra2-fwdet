...
// Last update by Thomas Eberl: 01/07/16 17:28:38
//
...
HParRootFileIo *input=new HParRootFileIo;
 ...
 rtdb->setFirstInput(input);
  ...
  richTasks->connect(new HRichChernovRingFitter("Rich Ring Fitter","Rich Ring Fitter",kFALSE));
...
TStopwatch timer;
gHades->setOutputFile("foo.root","RECREATE","Test",2);
gHades->makeTree();
