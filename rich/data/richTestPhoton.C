...
// Last update by Thomas Eberl: 01/07/16 12:32:47
//
...
HParRootFileIo *input=new HParRootFileIo;
 ...
 rtdb->setFirstInput(input);
  ...
  richTasks->connect(new HRichPhotonFinder("Rich Photon Finder","Rich Photon Finder"));
  //  richTasks->connect(new HRichChernovRingFitter("Rich Ring Fitter","Rich Ring Fitter",kTRUE),"Rich Photon Finder");
