...
#ifndef HRICH700DIGIMAPPAR_H_
#define HRICH700DIGIMAPPAR_H_
...
class HRich700DigiMapPar : public HParCond {
...
public:
    ...
    HRich700DigiMapPar(const Char_t* name   ="Rich700DigiMapPar",
		       const Char_t* title  ="PMT Mapping parameters for RICH",
		       const Char_t* context="Rich700DigiMapParProduction");
